CREATE OR REPLACE VIEW ANAPLAN.MD_ACCOUNT AS
WITH account_src AS (
    SELECT
        ac,
        ac_name,
...
COMMENT ON VIEW ANAPLAN.MD_ACCOUNT IS
    'Account hierarchy from bousr.fpm_account_structure. Oracle SubStr(x,0,n) converted to SUBSTRING(x,1,n-1).';