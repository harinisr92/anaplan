CREATE OR REPLACE VIEW ANAPLAN.AD_PRICELIST_CUSTOMER AS
WITH cte_costcenter_l3 AS (
    -- Inline of AD_COSTCENTER_L3CODE: divisions 100/300 costcenter lookup from MVXJDTA
    SELECT DISTINCT
...
COMMENT ON VIEW ANAPLAN.AD_PRICELIST_CUSTOMER IS
    'Customer pricelist assignments. AD_COSTCENTER_L3CODE logic inlined as CTE; no view-on-view dependency.';